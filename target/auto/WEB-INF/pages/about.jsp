...
<html lang="en">
  <head>
	...
	<script src="/auto/resources/js/Chart.js"/>"</script>
  ...
  <body>
	...
	<div class="container w">
		<div class="row centered">
			<br><br>
			<div class="col-lg-3">
				<img class="img-circle" src="/auto/resources/img/pic.jpg" width="110" height="110" alt="">
				<h4>Frank Lampard</h4>
			...
			<div class="col-lg-3">
				<img class="img-circle" src="/auto/resources/img/pic2.jpg" width="110" height="110" alt="">
				<h4>David Wright</h4>
				<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
			...
			<div class="col-lg-3">
				<img class="img-circle" src="/auto/resources/img/pic3.jpg" width="110" height="110" alt="">
			...
			<div class="col-lg-3">
				<img class="img-circle" src="/auto/resources/img/pic4.jpg" width="110" height="110" alt="">
				<h4>Tania Tissen</h4>
				<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
