		...
		<div class="container">
			<div class="row centered">
				...
				<div class="col-lg-2 col-lg-offset-1">
					<img src="<c:url value="/resources/img/c01.gif"/>" alt="">
				</div>
				<div class="col-lg-2">
					<img src="<c:url value="/resources/img/c02.gif"/>" alt="">
				</div>
				<div class="col-lg-2">
					<img src="<c:url value="/resources/img/c03.gif"/>" alt="">
				</div>
				<div class="col-lg-2">
					<img src="<c:url value="/resources/img/c04.gif"/>" alt="">
				</div>
				<div class="col-lg-2">
					<img src="<c:url value="/resources/img/c05.gif"/>" alt="">
				</div>
			</div><!-- row -->
		</div><!-- container -->
	</div><!-- dg -->
